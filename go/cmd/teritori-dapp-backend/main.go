...
func main() {
	...
	marketplacepb.RegisterMarketplaceServiceServer(server, &marketplace.MarkteplaceService{
		Logger:                   logger,
		UpcomingLaunchesProvider: airtable.NewUpcomingLaunchesProvider(context.TODO(), logger),
	})
