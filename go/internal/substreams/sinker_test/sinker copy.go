...
import (
	...
	pbsubstreams "github.com/streamingfast/substreams/pb/sf/substreams/rpc/v2"
	"gorm.io/gorm"
...
func (s *PostgresSinker) Run(ctx context.Context) error {
	...
	if err := s.Sinker.Run(ctx, cursor, s); err != nil {
...
func (s *PostgresSinker) HandleBlockScopedData(ctx context.Context, cursor *sink.Cursor, data *pbsubstreams.BlockScopedData) error {
