...
// SetNft is a paid mutator transaction binding the contract method 0xf3c13387.
//
// Solidity: function setNft(address newNftAddress) returns()
func (_TeritoriMinter *TeritoriMinterTransactor) SetNft(opts *bind.TransactOpts, newNftAddress common.Address) (*types.Transaction, error) {
	return _TeritoriMinter.contract.Transact(opts, "setNft", newNftAddress)
}

// SetNft is a paid mutator transaction binding the contract method 0xf3c13387.
//
// Solidity: function setNft(address newNftAddress) returns()
func (_TeritoriMinter *TeritoriMinterSession) SetNft(newNftAddress common.Address) (*types.Transaction, error) {
	return _TeritoriMinter.Contract.SetNft(&_TeritoriMinter.TransactOpts, newNftAddress)
}

// SetNft is a paid mutator transaction binding the contract method 0xf3c13387.
//
// Solidity: function setNft(address newNftAddress) returns()
func (_TeritoriMinter *TeritoriMinterTransactorSession) SetNft(newNftAddress common.Address) (*types.Transaction, error) {
	return _TeritoriMinter.Contract.SetNft(&_TeritoriMinter.TransactOpts, newNftAddress)
}
