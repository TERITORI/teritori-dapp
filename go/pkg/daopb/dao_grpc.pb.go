...
type DAOServiceClient interface {
	...
	IsUserLaunchpadAdmin(ctx context.Context, in *IsUserLaunchpadAdminRequest, opts ...grpc.CallOption) (*IsUserLaunchpadAdminResponse, error)
}
...
func (c *dAOServiceClient) IsUserLaunchpadAdmin(ctx context.Context, in *IsUserLaunchpadAdminRequest, opts ...grpc.CallOption) (*IsUserLaunchpadAdminResponse, error) {
	out := new(IsUserLaunchpadAdminResponse)
	err := c.cc.Invoke(ctx, "/dao.v1.DAOService/IsUserLaunchpadAdmin", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DAOServiceServer interface {
	...
	IsUserLaunchpadAdmin(context.Context, *IsUserLaunchpadAdminRequest) (*IsUserLaunchpadAdminResponse, error)
...
func (UnimplementedDAOServiceServer) IsUserLaunchpadAdmin(context.Context, *IsUserLaunchpadAdminRequest) (*IsUserLaunchpadAdminResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method IsUserLaunchpadAdmin not implemented")
}
...
func _DAOService_IsUserLaunchpadAdmin_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(IsUserLaunchpadAdminRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DAOServiceServer).IsUserLaunchpadAdmin(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/dao.v1.DAOService/IsUserLaunchpadAdmin",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DAOServiceServer).IsUserLaunchpadAdmin(ctx, req.(*IsUserLaunchpadAdminRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var DAOService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _DAOService_IsUserLaunchpadAdmin_Handler,
		},
	},
