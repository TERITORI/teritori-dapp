...
type Token struct {
	...
	ServerSignature []byte `protobuf:"bytes,5,opt,name=server_signature,json=serverSignature,proto3" json:"server_signature,omitempty"` // signature by server of protobuf encoding of Token with server_signature signature field zeroed out
}
...
func (x *Token) GetServerSignature() []byte {
	if x != nil {
...
var file_multisig_v1_multisig_proto_rawDesc = []byte{
	...
	0x75, 0x72, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x0f, 0x73, 0x65, 0x72, 0x76, 0x65,
