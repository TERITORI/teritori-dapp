...
export const teritoriSocialFeedQueries = {
  config: <TData = ConfigResponse>({
    client,
    options,
  }: TeritoriSocialFeedConfigQuery<TData>): UseQueryOptions<
    ConfigResponse,
    Error,
    TData
  > => ({
    queryKey: teritoriSocialFeedQueryKeys.config(client?.contractAddress),
    queryFn: () =>
  ...
  queryFeeByCategory: <TData = QueryFeeByCategoryResponse>({
    client,
    args,
    options,
  }: TeritoriSocialFeedQueryFeeByCategoryQuery<TData>): UseQueryOptions<
    QueryFeeByCategoryResponse,
    Error,
    TData
  > => ({
    queryKey: teritoriSocialFeedQueryKeys.queryFeeByCategory(
  ...
  queryLockedTokens: <TData = QueryLockedTokensResponse>({
    client,
    args,
    options,
  }: TeritoriSocialFeedQueryLockedTokensQuery<TData>): UseQueryOptions<
    QueryLockedTokensResponse,
    Error,
    TData
  > => ({
    queryKey: teritoriSocialFeedQueryKeys.queryLockedTokens(
      client?.contractAddress,
      args
    ),
    queryFn: () =>
  ...
  queryAvailableFreePosts: <TData = QueryAvailableFreePostsResponse>({
    client,
    args,
    options,
  }: TeritoriSocialFeedQueryAvailableFreePostsQuery<TData>): UseQueryOptions<
    QueryAvailableFreePostsResponse,
    Error,
    TData
  > => ({
    queryKey: teritoriSocialFeedQueryKeys.queryAvailableFreePosts(
      client?.contractAddress,
      args
    ),
    queryFn: () =>
  ...
  queryPost: <TData = QueryPostResponse>({
    client,
    args,
    options,
  }: TeritoriSocialFeedQueryPostQuery<TData>): UseQueryOptions<
    QueryPostResponse,
    Error,
    TData
  > => ({
    queryKey: teritoriSocialFeedQueryKeys.queryPost(
      client?.contractAddress,
      args
    ),
    queryFn: () =>
  ...
  querySubPost: <TData = QuerySubPostResponse>({
    client,
    args,
    options,
  }: TeritoriSocialFeedQuerySubPostQuery<TData>): UseQueryOptions<
    QuerySubPostResponse,
    Error,
    TData
  > => ({
    queryKey: teritoriSocialFeedQueryKeys.querySubPost(
      client?.contractAddress,
      args
    ),
    queryFn: () =>
  ...
  querySubPosts: <TData = QuerySubPostsResponse>({
    client,
    args,
    options,
  }: TeritoriSocialFeedQuerySubPostsQuery<TData>): UseQueryOptions<
    QuerySubPostsResponse,
    Error,
    TData
  > => ({
    queryKey: teritoriSocialFeedQueryKeys.querySubPosts(
      client?.contractAddress,
      args
    ),
    queryFn: () =>
  ...
  queryMainPosts: <TData = QueryMainPostsResponse>({
    client,
    args,
    options,
  }: TeritoriSocialFeedQueryMainPostsQuery<TData>): UseQueryOptions<
    QueryMainPostsResponse,
    Error,
    TData
  > => ({
    queryKey: teritoriSocialFeedQueryKeys.queryMainPosts(
      client?.contractAddress,
      args
    ),
    queryFn: () =>
  ...
  queryMainPostsCount: <TData = QueryMainPostsCountResponse>({
    client,
    options,
  }: TeritoriSocialFeedQueryMainPostsCountQuery<TData>): UseQueryOptions<
    QueryMainPostsCountResponse,
    Error,
    TData
  > => ({
    queryKey: teritoriSocialFeedQueryKeys.queryMainPostsCount(
      client?.contractAddress
    ),
    queryFn: () =>
      client
