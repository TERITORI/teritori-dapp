...
// TODO: ask Yield to fix types
type IsCollectionWhitelistedResponse = any;
type StakeInfoResponse = any;
...
export class TeritoriNftStakingQueryClient
  implements TeritoriNftStakingReadOnlyInterface
{
...
export interface TeritoriNftStakingInterface
  extends TeritoriNftStakingReadOnlyInterface {
  contractAddress: string;
  sender: string;
  updateConfig: (
    {
...
export class TeritoriNftStakingClient
  extends TeritoriNftStakingQueryClient
  implements TeritoriNftStakingInterface
{
