...
export const UserCard: React.FC<{
  ...
  const selectedWalletIsMember = useIsDAOMember(daoId, selectedWallet?.userId);
  ...
  return (
    ...
    >
      <OmniLink to={{ screen: "UserPublicProfile", params: { id: userId } }}>
        ...
        >
          {metadata.public_name || tinyAddress(userAddress, 40)}
        </BrandText>
        <View>
          <BrandText
...
const useProposeToRemoveMember = (daoId: string) => {
