        ...
        <View style={{flex: 3, flexDirection: "row"}}>
            <View style={{flex: 1}}>
                <View style={{flexDirection:"row"}}>
                    ...
                    <Separator style={{ flex: 1, alignSelf: "center", marginHorizontal: 20}} />
                </View>
                <View style={{flexDirection:"column", marginTop: 10}}>
                    <BrandText style={fontSemibold14}>1. Create a Gig</BrandText>
                    <View style={{flexDirection:"row", marginTop: 5}}>
                        <BrandText style={[fontMedium14,{flex: 3, color: neutral77}]}>
                            Register without any charges, create your Gig, and present our services to our worldwide audience
                        </BrandText>
            ...
            <View style={{flex: 1}}>
                ...
                <View style={{flexDirection:"column", marginTop: 10}}>
                    <BrandText style={fontSemibold14}>2. Deliver great work</BrandText>
                    <View style={{flexDirection:"row", marginTop: 5}}>
                        <BrandText style={[fontMedium14,{flex: 3, color: neutral77}]}>
                            Receive Alerts upon receiving an order and utilize our platform to communicate and discuss specifics with your clients
                        </BrandText>
                        <View style={{flex: 1}}></View>
                    </View>
                </View>
            ...
            <View style={{flex: 1}}>
                ...
                <View style={{flexDirection:"column", marginTop: 10}}>
                    ...
                    <View style={{flexDirection:"row", marginTop: 5}}>
                        <BrandText style={[fontMedium14,{flex: 3, color: neutral77}]}>
                            Get paid punctually and consistently. Once the payment is cleared, it becoms available for withdrawal.
                        </BrandText>
                        <View style={{flex: 1}}></View>
                    </View>
                </View>
...
const styles = StyleSheet.create({
  svg:{
    width: 56, height: 56, borderRadius: 100, backgroundColor: neutral17, alignItems: "center", justifyContent:"center",
    borderWidth: 1, borderColor: neutral33
  }
});
