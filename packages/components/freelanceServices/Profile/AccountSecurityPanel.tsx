...
export const AccountSecurityPanel: React.FC<{
  ...
  const [openVerifyPhoneModal, setOpenVerifyPhoneModal] = useState<boolean>(true);
      ...
      <View style={styles.contentContainer}>
        <View style={styles.accountBox}>
          <View style={styles.iconBox}>
            <SVG source={EmailIcon} width={24} height={24} style={{ marginRight: layout.padding_x2 }} />
            <BrandText>Email</BrandText>
          </View>
          <TertiaryButton text="Verified" size="M" disabled={true} />
        </View>
        <View style={styles.accountBox}>
          <View style={styles.iconBox}>
            <SVG source={PhoneIcon} width={24} height={24} style={{ marginRight: layout.padding_x2 }} />
            <BrandText>Phone Number</BrandText>
          </View>
          <TertiaryButton text="Add Number" size="M" textColor={primaryColor} onPress={() => setOpenVerifyPhoneModal(true)} />
        </View>
      </View>

      <VerifyPhoneModal visible={openVerifyPhoneModal} onClose={() => setOpenVerifyPhoneModal(false)} />
