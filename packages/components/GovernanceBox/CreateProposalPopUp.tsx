...
export const CreateProposalPopUp: React.FC < {
	...
	const [displayCreateBountyMission, setdisplayCreateBountyMission] = useState(visible);
	const [lastPorposalId, setlastPorposalId] = useState("")

    useEffect(() => {
        fetch('https://rest.testnet.teritori.com/cosmos/gov/v1beta1/proposals')
          .then(res => res.json())
          .then(kl => setlastPorposalId(kl.proposals[kl.proposals.length - 1].proposal_id))
      }, [])
	...
	return (
        ...
        width={632}>
            ...
            <View style={{display: "flex", flexDirection: "column", marginBottom: 25, marginTop: 10}}>
			...
			<View style={{flexDirection: "column", alignContent: "center", margin: 10}}>
				<View style={{alignContent: "center", justifyContent: "center", marginTop: 10, marginBottom: 15}}>
					<PrimaryButton 
                        width={575}
                        size="XL"
                        text="Create mission"
