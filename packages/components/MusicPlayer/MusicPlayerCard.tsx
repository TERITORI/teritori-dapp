...
import { fontSemibold14, fontMedium14, fontSemibold13 } from "../../utils/style/fonts";
  ...
  return (
    <View style={styles.unitCard}>
      ...
      >
        ...
        {selectedIndex === index + 1 && <TrackImageHover mine={mine} />}
      </View>
      <BrandText style={styles.contentTitle}>{item.title}</BrandText>
      <BrandText style={styles.contentDescription}>
        {item.description}
      </BrandText>
      {!mine && <Pressable><BrandText style={styles.contentName}>@{item.name}</BrandText></Pressable>}
    </View>
  );
};
