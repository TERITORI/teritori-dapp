...
import { getMusicAudioPostTrack } from "../NewsFeed/NewsFeedQueries";
...
export const SocialCommentCard: React.FC<SocialCommentCardProps> = ({
  ...
  const track: Track | undefined = getMusicAudioPostTrack(localComment);
          ...
          <View style={[styles.commentContainer, style]}>
            ...
            <View style={styles.commentContainerInside}>
              ...
              <SocialCardHeader
                ...
                createdAt={track?.createdAt || metadata.createdAt}
