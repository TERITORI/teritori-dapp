...
>(
  (
    ...
    const { freePostCount } = useFreePostsCount(
      userId,
      getPostCategory(formValues),
    );
    const { prettyPostFee } = useFeedPostFee(
      userId,
      getPostCategory(formValues),
    );
    const { makeSimplePost, isProcessing, isLoading } = useMakePost({
    ...
    const processSubmit = () => {
      ...
      makeSimplePost({
        ...
        parentPostIdentifier: isReplyToValid ? replyTo?.parentId : parentId,
      });
    };
          ...
          >
            ...
            >
              {freePostCount
                ...
                : `The cost for this ${type} is ${prettyPostFee}`}
            </BrandText>
          </View>
          <View
            style={[
