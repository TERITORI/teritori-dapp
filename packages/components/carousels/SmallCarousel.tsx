...
const PrevButton: React.FC<ButtonProps> = ({onPress, shadowHeight, style}) => {
  return (
    <TouchableOpacity
      activeOpacity={1}
      onPress={onPress}
    ...
    >
      <InnerSideBlackShadow side="left" height={shadowHeight} style={styles.buttonShadow}>
...
const NextButton: React.FC<ButtonProps> = ({onPress, shadowHeight, style}) => (
  <TouchableOpacity
    activeOpacity={1}
    onPress={onPress}
    style={[styles.buttonContainer, {right: 0}, style]}
  >
    <InnerSideBlackShadow side="right" height={shadowHeight} style={styles.buttonShadow}>
      <SVG width={chevronSize} height={chevronSize} source={chevronRightSVG} />
    </InnerSideBlackShadow>
  </TouchableOpacity>
)

export const SmallCarousel: React.FC<TCarouselProps & {height: number;}> = (props) => {
