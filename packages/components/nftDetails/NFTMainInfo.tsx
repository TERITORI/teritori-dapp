...
export const NFTMainInfo: React.FC<{
  ...
  return (
    <>
      ...
      {showMarketplace && (
        <Target style={collapsableContainerStyle} name="price-history">
          <Suspense fallback={<></>}>
            <CollapsablePriceHistory nftId={nftId} />
          </Suspense>
        </Target>
      )}
      <Target name="activity" style={collapsableContainerStyle}>
...
const collapsableContainerStyle: ViewStyle = {
  width: "100%",
