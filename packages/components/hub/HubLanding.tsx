  ...
  return (
    <View
      style={{
        ...
        flexWrap: "wrap",
        justifyContent:
          windowWidth < smallMobileWidth ? "flex-start" : "center",
        margin: -gridHalfGutter,
      }}
    >
      <MyWalletsCard onPress={() => navigation.navigate("WalletManager")} />
      <DAppCard
...
export const CommingCardGroup = () => {
  ...
  return (
    ...
    >
      ...
      <LabelCard label="Group Chats" style={{ margin: gridHalfGutter }} />
      <LabelCard label="DAO Launch" style={{ margin: gridHalfGutter }} />
      <DAppCard
        label="Contribute!"
