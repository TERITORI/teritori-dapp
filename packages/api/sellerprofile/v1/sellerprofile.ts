...
export interface SellerprofileService {
  updateProfile(
    request: DeepPartial<SellerProfileRequest>,
    metadata?: grpc.Metadata,
  ): Observable<SellerProfileResponse>;
}

export class SellerprofileServiceClientImpl implements SellerprofileService {
  ...
  updateProfile(
    ...
    return this.rpc.invoke(SellerprofileServiceUpdateProfileDesc, SellerProfileRequest.fromPartial(request), metadata);
  }
}

export const SellerprofileServiceDesc = { serviceName: "sellerprofile.v1.SellerprofileService" };

export const SellerprofileServiceUpdateProfileDesc: UnaryMethodDefinitionish = {
  methodName: "UpdateProfile",
  service: SellerprofileServiceDesc,
  requestStream: false,
  responseStream: true,
  requestType: {
    serializeBinary() {
