...
export const LaunchpadERC20CreateTokenSign: React.FC = () => {
  ...
  const launchpadERC20CreateTokenSign = async () => {
    try {
      ...
      if (!createTokenFormBasics.decimals) {
        setIsShowConfirmModal(false);
        throw Error("Decimals is required");
      }
    ...
    >
      ...
      >
        ...
        <PrimaryButton
          ...
          onPress={launchpadERC20CreateTokenSign}
        />
