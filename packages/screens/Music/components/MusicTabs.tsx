...
import HomeIcon from "../../../../assets/icons/music/home.svg";
import MusicIcon from "../../../../assets/icons/music/music.svg";
  ...
  return (
    <View style={tabContainerStyle}>
      ...
      >
        <SVG
          source={HomeIcon}
          color={tab === tabData[0] ? secondaryColor : neutralA3}
      ...
      >
        <SVG
          source={MusicIcon}
          color={tab === tabData[1] ? secondaryColor : neutralA3}
          width={layout.spacing_x3}
          height={layout.spacing_x3}
        />
        <SpacerRow size={1.5} />
