      ...
      <View style={styles.pageContainer}>
        <View style={styles.cardContainer}>
          <TouchableOpacity
            onPress={() => {
              setSettingsInfo({
                ...settingsInfo,
                displayTestnet: !settingsInfo.displayTestnet,
              });
            }}
          >
        ...
        <View style={styles.cardContainer}>
          <View style={[styles.switchBox, { paddingTop: 0 }]}>
            ...
            <Pressable
              onPress={() => setSettingsInfo({ ...settingsInfo, apiKey: "" })}
            >
          ...
          <TextInput
            ...
            onChangeText={(value) =>
              setSettingsInfo({ ...settingsInfo, apiKey: value })
            }
          />
        </View>
        ...
        <View style={styles.cardContainer}>
          ...
          <TouchableOpacity
            onPress={() => {
              setSettingsInfo({
                ...settingsInfo,
                successfulBids: !settingsInfo.successfulBids,
              });
            }}
          >
          ...
          <TouchableOpacity
            onPress={() => {
              setSettingsInfo({
                ...settingsInfo,
                doubleBids: !settingsInfo.doubleBids,
              });
            }}
          >
            <View style={styles.switchBox}>
          ...
          <TouchableOpacity
            onPress={() => {
              setSettingsInfo({
                ...settingsInfo,
                expireBids: !settingsInfo.expireBids,
              });
            }}
          >
            <View style={styles.switchBox}>
          ...
          <TouchableOpacity
            onPress={() => {
              setSettingsInfo({
                ...settingsInfo,
                purchase: !settingsInfo.purchase,
              });
            }}
          >
            <View style={styles.switchBox}>
        ...
        <View style={styles.cardContainer}>
          <TouchableOpacity
            onPress={() =>
              setSettingsInfo({ ...settingsInfo, openConfirm: true })
            }
          >
            <View style={[styles.switchBox, { paddingTop: 0 }]}>
              <BrandText style={styles.cardTitle}>
        ...
        {settingsInfo.openConfirm && (
          <View style={styles.switchBox}>
            <TertiaryButton
              ...
              text="Cancel"
              onPress={() =>
                setSettingsInfo({ ...settingsInfo, openConfirm: false })
              }
            />
            <PrimaryButton
              size="M"
              text="Save"
              onPress={() =>
                setSettingsInfo({ ...settingsInfo, openProfile: true })
              }
            />
          </View>
        )}
