      ...
      {selectedTask != null && (
        ...
        >
          ...
          <BrandText style={[fontSemibold13, { color: neutralA3 }]}>
            ...
            local, local community engagement. The platform should help Platform
            users in different regions coordinate meet-ups, translations of
            Platform content into local languages, and to University outreach
            programs.
          </BrandText>
