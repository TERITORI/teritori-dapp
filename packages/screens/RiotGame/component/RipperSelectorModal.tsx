...
const RipperSelectorModal: React.FC<RipperSelectorModalProps> = ({ slotId, onClose, onSelectRipper, availableRippers, visible, ...props }) => {
    const [selectedRipper, setSelectedRipper] = useState<NSRiotGame.Ripper | undefined>();
    ...
    >
        <View style={styles.container}>
            <BrandText style={fontMedium48}>{selectedRipper?.name || 'Please select a Ripper'}</BrandText>
            ...
            <View style={styles.row}>
                ...
                <View style={styles.rightCol}>
                    ...
                    <RipperStat containerStyle={styles.ripperStatContainer} name='Stamina' value={selectedRipper?.stamina || 0} />
                    <RipperStat containerStyle={styles.ripperStatContainer} name='Protection' value={selectedRipper?.protection || 0} />
                    <RipperStat containerStyle={styles.ripperStatContainer} name='Luck' value={selectedRipper?.luck || 0} />

                    <View style={styles.btnGroup}>
                        <SVG source={gamepadSVG} />
                        <SpacerRow size={2} />
                        <SimpleButton onPress={enrollRipper} size="small" title='Enroll this Ripper' />
                    </View>
                </View>
            </View>
        </View>
