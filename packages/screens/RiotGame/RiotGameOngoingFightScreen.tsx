        ...
        >
          <Row breakpoint={992}>
            <View style={{ flex: 1 }}>
              ...
              <Row>
                <BrandText style={[fontMedium48, { color: redDefault }]}>
                  6h 47m 56s
                </BrandText>
                <SpacerRow size={2} />
                <SVG color={redDefault} source={clockSVG} />
              </Row>
            </View>
            ...
            <Row style={styles.actionsSection}>
              ...
              <SVG source={unstakeSVG} />
              <BrandText style={styles.actionLabel}>Unstake</BrandText>
