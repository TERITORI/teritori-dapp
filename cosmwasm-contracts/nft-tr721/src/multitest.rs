...
use crate::{
    ...
    error::ContractError, hasher::TrKeccak256,
};
...
const MERKLE_ROOT: &str = "32375e3025063c35b9fa473d6aa3bf5cb25abcb0835dbfb64fe756be35af9548";
...
fn full_flow() {
    ...
    // Test mint with merkle path
    {
        ...
        let nft_hashes: Vec<[u8; 32]> = nfts
            .iter()
            .map(|x| TrKeccak256::hash(&to_json_vec(x).unwrap()))
            .collect();
