...
const MERKLE_ROOT: &str = "ba8610788641e1d89f4a5f07e3b6b69ce7e8dc2a3eaab49d79b158cf9c304835";
...
fn full_flow() {
    ...
    // Test mint with merkle path
    {
        let nft0 = Metadata {
            ...
            attributes: Some(vec![
                Trait {
                    display_type: Some("display0".to_string()),
                    trait_type: "type0".to_string(),
                    value: "value0".to_string(),
                },
                Trait {
                    display_type: Some("display1".to_string()),
