...
unused-exports: node_modules
	...
	npx ts-unused-exports ./tsconfig.json --excludePathsFromReport="packages/api;packages/contracts-clients;packages/evm-contracts-clients;packages/components/socialFeed/RichText/inline-toolbar;packages/store;packages/networks;./App.tsx;.*\.web|.electron|.d.ts" --ignoreTestFiles 
